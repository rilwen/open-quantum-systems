...
namespace cfa {
	class MatrixFieldApproximationHigherOrder
	{
	public:
	...
	public:
		...
		//! g is KxN
		//! omega is Kx1
		CFA_API MatrixFieldApproximationHigherOrder(const Eigen::MatrixXcd& H0, const Eigen::MatrixXcd& g, const Eigen::VectorXd& omega, double kBT = 0, bool fixed_bath = false);
		...
		struct Normalizer
		{
			CFA_API Normalizer(const MatrixFieldApproximationHigherOrder&) {}
		...
		static const char* name() { return "MFAHO"; }
	private:
		...
		operator_type exciton_bath_operator(data_type& y, size_t m, size_t n, size_t k) const;
		const_operator_type exciton_bath_operator(const data_type& y, size_t m, size_t n, size_t k) const;
		//! int_0^t H(t) dt
		...
		size_t exciton_bath_index(size_t m, size_t n, size_t k) const;
	...
	private:
		...
		Eigen::MatrixXcd m_work;
		Eigen::MatrixXcd m_work2;
		double m_kBT;
		bool m_fixed_bath;
		size_t m_dim;
		...
		size_t m_nbr_exciton_values_both_halves;
		size_t m_exciton_bath_product_offset;
